(function(window) {
  ...
  jsmpeg.prototype.loadNextChunk = function() {
    ...
    var start = this.buffer.writePos,
        ...
        this.buffer.writePos + that.progressiveChunkSize - 1,
        this.fileSize - 1
      );
  ...
  jsmpeg.prototype.progressiveLoadCallback = function(data) {
    ...
    var remainingTimeToPlay =
      (this.buffer.writePos - playIndex) / bytesPerSecondPlayed;
    var remainingTimeToLoad =
      (this.fileSize - this.buffer.writePos) / bytesPerSecondLoaded;
    var totalRemainingPlayTime =
      (this.fileSize - playIndex) / bytesPerSecondPlayed;
    ...
    if (remainingTimeToPlay > loadTime * 8) {
      this.progressiveChunkSize = Math.min(
        this.progressiveChunkSize * 2,
        this.progressiveChunkSizeMax
      );
    }
    ...
    if (this.progressiveThrottled && this.canPlayThrough) {
      this.nextChunkLoadAt =
        this.buffer.writePos -
        this.progressiveChunkSize * 2 -
        this.progressiveChunkSize *
          (bytesPerSecondPlayed / bytesPerSecondLoaded) *
          4;
    } else {
